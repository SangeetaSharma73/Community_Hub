...
import { resetPasswordEndpoint } from "../../utils/endpoint"; // Ensure this points to the correct endpoint
...
const ResetPassword = () => {
  ...
  const onResetPasswordFormSubmit = async (e) => {
    ...
    try {
      // Make sure the URL uses the token and password
      const response = await axios.post(`${resetPasswordEndpoint}/${token}`, {
        newPassword,
      });
